...
const localization = {
  ...
  "ua" : {
    ...
    "description": [
      ...
      [`У додатку є наступні  валюти: ${AVAILABLE_CURRENCIES.join(', ')} пізніше можливо буде більше.`,
        [
      ...
      ["Немає реєстрації, тобто дані користувача нi кому не передаються, та нi де не зберігаються. Ніхто не має доступу до ваших покупок."],
